...
/**
*	Convenience class that defines a special type of Journal: the TPL Journal.
*	In this implementation the TplJournalImpl doesn't add any significant behaviour to the base JournalImpl class.
*	\todo	Add behaviour to this class in order to support Transaction.
**/
class TplJournalImpl : public JournalImpl
{
  public:
    ...
    *	This constructor simply class the super class constructor.
    *	@param	timer			QPID Timer used to create timeout
    *	@param	journalId		Journal Identifier used as Journal Name
    *	@param	journalDirectory	Directory for this Journal
    *	@param	journalBaseFilename	Base directory for all Berkeley Databases
    *	@param	flushTimeout		Duration for the flush timeout
    *	@param	agent			Agent for the managemnt
    *	@param	de			Pointer to the Berkeley Database Environment used in the Store
    **/
